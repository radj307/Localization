...
namespace Testing
{
    ...
    public static class StringHelper
    {
        ...
        public static string GetFullMethodName(this MethodInfo method)
            => method.GetFullMethodName(MethodNamePart.FullDeclaringTypeName | MethodNamePart.GenericParameters | MethodNamePart.Parameters | MethodNamePart.NonVoidReturnType);
